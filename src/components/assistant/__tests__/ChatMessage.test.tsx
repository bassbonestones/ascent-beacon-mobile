...
describe("ChatMessage", () => {
  it("should render user message correctly", () => {
    ...
    expect(screen.getByText("Hello assistant")).toBeOnTheScreen();
  });
  ...
  it("should render assistant message correctly", () => {
    ...
    expect(screen.getByText("Hello user")).toBeOnTheScreen();
  });
  ...
  it("should have accessibility label for user message", () => {
    ...
    expect(screen.getByLabelText("You: Test message")).toBeOnTheScreen();
  });
  ...
  it("should have accessibility label for assistant message", () => {
    ...
    expect(screen.getByLabelText("Assistant: AI response")).toBeOnTheScreen();
  });
