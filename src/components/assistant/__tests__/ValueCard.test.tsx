...
describe("ValueCard", () => {
  ...
  it("renders value statement", () => {
    ...
    expect(getByText("I value honesty")).toBeOnTheScreen();
  });

  it("renders declared origin correctly", () => {
    const { getByText } = render(<ValueCard {...defaultProps} />);
    expect(getByText("Declared")).toBeOnTheScreen();
  });
  ...
  it("shows delete confirmation when isDeleting is true", () => {
    ...
    expect(getByText("Delete this value?")).toBeOnTheScreen();
  });
  ...
  it("has confirm delete button when isDeleting", () => {
    ...
    expect(getByLabelText("Confirm delete")).toBeOnTheScreen();
  });
  ...
  it("has cancel delete button when isDeleting", () => {
    ...
    expect(getByLabelText("Cancel delete")).toBeOnTheScreen();
  });
  ...
  it("renders insight when provided", () => {
    ...
    expect(getByText("This value seems similar to another")).toBeOnTheScreen();
  });
  ...
  it("renders review button when insight has similar_value_id", () => {
    ...
    expect(getByLabelText("Review similar value")).toBeOnTheScreen();
  });
  ...
  it("renders keep both button when insight provided", () => {
    ...
    expect(getByLabelText("Keep both values")).toBeOnTheScreen();
  });
});
