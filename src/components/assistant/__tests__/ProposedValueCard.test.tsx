...
import ProposedValueCard from "../ProposedValueCard";
...
describe("ProposedValueCard", () => {
  ...
  it("renders proposed value label", () => {
    ...
    expect(getByText("Proposed Value")).toBeOnTheScreen();
  });
  ...
  it("renders value statement", () => {
    ...
    expect(getByText("Test value statement")).toBeOnTheScreen();
  });
  ...
  it("renders reject button with correct text", () => {
    ...
    expect(getByText("Not Quite")).toBeOnTheScreen();
  });
  ...
  it("renders accept button with correct text", () => {
    ...
    expect(getByText("Add This")).toBeOnTheScreen();
  });
  ...
  it("has correct accessibility label for card", () => {
    ...
    expect(getByLabelText("Proposed value: Test value statement")).toBeOnTheScreen();
  });
