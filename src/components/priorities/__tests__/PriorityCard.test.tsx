...
describe("PriorityCard", () => {
  ...
  it("should render why_matters description", () => {
    ...
    expect(screen.getByText("This matters because...")).toBeOnTheScreen();
  });
  ...
  it("should render importance score", () => {
    ...
    expect(screen.getByText("Importance: 4/5")).toBeOnTheScreen();
  });
  ...
  it("should show anchored badge when is_anchored is true", () => {
    ...
    expect(screen.getByText("🔒 Anchored")).toBeOnTheScreen();
  });
  ...
  it("should show stashed badge when isStashed is true", () => {
    ...
    expect(screen.getByText("Stashed")).toBeOnTheScreen();
  });
  ...
  it("should default score to 3 when not provided", () => {
    ...
    expect(screen.getByText("Importance: 3/5")).toBeOnTheScreen();
  });
});
