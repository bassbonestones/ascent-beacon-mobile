...
describe("AuthOptions", () => {
  ...
  it("renders Google sign-in button", () => {
    ...
    expect(getByText("Continue with Google")).toBeOnTheScreen();
  });
  ...
  it("renders 'Log In with Code' button when email input is hidden", () => {
    ...
    expect(getByText("Log In with Code")).toBeOnTheScreen();
  });
  ...
  it("renders 'Send Code' button when email input is shown", () => {
    ...
    expect(getByText("Send Code")).toBeOnTheScreen();
  });
  ...
  it("shows email input when showEmailInput is true", () => {
    ...
    expect(getByPlaceholderText("Enter your email")).toBeOnTheScreen();
  });
  ...
  it("displays terms disclaimer", () => {
    const { getByText } = render(<AuthOptions {...defaultProps} />);
    expect(getByText(/By logging in, you agree to our/)).toBeOnTheScreen();
  });
