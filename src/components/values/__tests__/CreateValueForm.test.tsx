...
describe("CreateValueForm", () => {
  const defaultProps: CreateValueFormProps = {
    valuesCount: 0,
    newStatement: "",
  ...
  it("renders 'Create Your First Value' title when no values exist", () => {
    ...
    expect(getByText("Create Your First Value")).toBeOnTheScreen();
  });
  ...
  it("renders 'Add Another Value' title when values exist", () => {
    ...
    expect(getByText("Add Another Value")).toBeOnTheScreen();
  });
  ...
  it("renders text input with placeholder", () => {
    ...
    expect(getByPlaceholderText("I choose to...")).toBeOnTheScreen();
  });
  ...
  it("renders See examples link", () => {
    ...
    expect(getByText("See examples")).toBeOnTheScreen();
  });
  ...
  it("renders 'Create Value' button for first value", () => {
    ...
    expect(getByText("Create Value")).toBeOnTheScreen();
  });
  ...
  it("renders 'Add Value' button for subsequent values", () => {
    ...
    expect(getByText("Add Value")).toBeOnTheScreen();
  });
  ...
  it("shows hint text when has minimum values and can add more", () => {
    ...
    expect(getByText(/You have 4 values/)).toBeOnTheScreen();
    expect(getByText(/You can add up to 2 more/)).toBeOnTheScreen();
  });
