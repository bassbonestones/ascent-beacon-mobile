...
import ValueListCard from "../ValueListCard";
...
describe("ValueListCard", () => {
  ...
  it("should render value statement", () => {
    ...
    expect(screen.getByText("I value honesty and integrity")).toBeOnTheScreen();
  });
  ...
  it("should display weight when provided", () => {
    ...
    expect(screen.getByText("Weight: 25.5%")).toBeOnTheScreen();
  });
